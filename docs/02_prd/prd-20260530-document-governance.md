...
docs/
  ...
  agents/          machine-consumed agent contracts required by project skills
```
...
- Machine-consumed agent contracts may remain under `docs/agents/` when external skills require those stable paths.
