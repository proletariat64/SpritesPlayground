...
- `addons/limboai/` and `addons/godot_ai/` must remain ignored and untracked.
...
- Installer and bootstrap behavior tests pass without downloading release archives or Pi packages.
